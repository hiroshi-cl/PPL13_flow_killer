...
import graph.FlowGraphPositiveInt.E;
import graph.FlowGraphPositiveInt.V;

import java.io.PrintWriter;
import java.io.StringWriter;
import java.util.*;

public class FlowGraphInt {
	public static final int INF = Integer.MAX_VALUE;
	private final V[] vs;

	public FlowGraphInt(final int n, final Oracles o) {
		this.vs = new V[n];
		for (int i = 0; i < n; i++)
